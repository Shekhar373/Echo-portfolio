  ...
  return (
    <div className="h-screen w-full bg-white relative ">
      <div className="h-screen w-full absolute top-[12%] lg:top-0 lg:flex justify-between lg:items-center p-5 text-[10vw] max-md:leading-[10vw] lg:text-[3vw]">
        <div className="lg:tracking-tighter text-[10vw] max-md:leading-[10vw] flex flex-col lg:flex-row lg:gap-2">
          <h1>Creative</h1>
          <h1>Videos</h1>
        </div>
      ...
      <div className="absolute bottom-[22%] p-5">
        <h1 className="text-zinc-400 max-sm:text-sm lg:hidden flex">
          Drag to explore the collection
        </h1>
      </div>
      <HeroGallery />
